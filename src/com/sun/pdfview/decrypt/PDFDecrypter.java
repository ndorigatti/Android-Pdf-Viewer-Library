...
/**
 * A decrypter decrypts streams and strings in a PDF document. {@link #decryptBuffer(String, PDFObject, ByteBuffer)} should be used for decoding
...
public interface PDFDecrypter {
	 ...
	 * @param objGen
	 *            the generation number of the containing object
	 * @param inputBasicString
