 ...
 * </p>
 * <p>
 * A PDF function maps some set of <i>m</i> inputs into some set of <i>n</i> outputs. There are 4 types of functions:
 * <ul>
 * <li>Type 0: Sampled functions. (PDF 1.2)<br>
 * A sampled function (type 0) uses a table of sample values to define the function. Various techniques are used to interpolate values between the sample values
 * (see Section 3.9.1, "Type 0 (Sampled) Functions").</li>
 * <li>Type 2: Exponential Interpolation. (PDF 1.3)<br>
 * An exponential interpolation function (type 2) defines a set of coefficients for an exponential function (see Section 3.9.2,
 * "Type 2 (Exponential Interpolation) Functions").</li>
 * <li>Type 3: Stitching functions. (PDF 1.3)<br>
 * A stitching function (type 3) is a combination of other functions, partitioned across a domain (see Section 3.9.3, "Type 3 (Stitching) Functions").</li>
 * <li>Type 4: Postscript calculations. (PDF 1.3)<br>
 * A PostScript calculator function (type 4) uses operators from the PostScript language to describe an arithmetic expression (see Section 3.9.4,
 * "Type 4 (PostScript Calculator) Functions").</li>
 * </ul>
 * </p>
 * <p>
 * The function interface contains a single method, <i>calculate</i> which takes an array of <i>m</i> floats an interprets them into an array of </i>n</i>
 * floats.
 * <p>
 * PDFFunctions do not have accessible constructors. Instead, use the static <i>getFunction()</i> method to read a functions from a PDF Object.
 */
public abstract class PDFFunction {
	 ...
	 * 
	 * @param inputs
	 *            guaranteed to be at least as big as <code>getNumInputs()</code> and all values within range
	 * @param inputOffset
	 *            the offset into the inputs array to read from
	 * @param outputs
	 *            guaranteed to be at least as big as <code>getNumOutputs()</code>, but not yet clipped to domain
	 * @param outputOffset
	 *            the offset into the output array to write to
	 */
