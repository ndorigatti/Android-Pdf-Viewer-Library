...
public class TrueTypeFont {
	...
	private int getLength() {
		...
		for (Iterator<Object> i = tables.values().iterator(); i.hasNext();) {
	...
	public String toString() {
		...
		Log.d(Constants.TAG, "Type         : " + getType());
		Log.d(Constants.TAG, "NumTables    : " + getNumTables());
		Log.d(Constants.TAG, "SearchRange  : " + getSearchRange());
		Log.d(Constants.TAG, "EntrySelector: " + getEntrySelector());
		Log.d(Constants.TAG, "RangeShift   : " + getRangeShift());

		for (Iterator<Map.Entry<String, Object>> i = tables.entrySet().iterator(); i.hasNext();) {
			...
			Log.d(Constants.TAG, table.toString());
		}
