...
public abstract class CMap {
	 ...
	 * </p>
	 * <p>
	 * Formats 8, 10, and 12 (properly 8.0, 10.0, and 12.0) are used for mixed 16/32-bit and pure 32-bit mappings.<br>
	...
	public static CMap createMap(short format, short language) {
		...
		switch (format) {
			...
			// break;
			default:
				Log.e(Constants.TAG, "Unsupport CMap format: " + format);
				return null;
		}
