...
public class Type1CFont extends OutlineFont {
	...
	private void readDict(Range r) {
		...
		while (pos < r.getEnd()) {
			...
			if (cmd == 1006) { // charstringtype, default=2
				...
				if (stackptr == 4) {
					at = Utils.createMatrix((float) stack[0], (float) stack[1], (float) stack[2], (float) stack[3], 0, 0);
				} else {
					at = Utils.createMatrix((float) stack[0], (float) stack[1], (float) stack[2], (float) stack[3], (float) stack[4], (float) stack[5]);
				}
	 ...
	 * 
	 * @param encdif
	 *            a dictionary describing the encoding.
	 */
	 ...
	 * 
	 * @param x
	 *            the x offset of the accent
	 * @param y
	 *            the y offset of the accent
	 * @param b
	 ...
	 * 
	 * @param r
	 *            the range of the glyph definition
	 * @param gp
	 *            a GeneralPath in which to store the glyph outline
	 * @param pt
