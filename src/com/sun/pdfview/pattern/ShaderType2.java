...
public class ShaderType2 extends PDFShader {
    ...
    private PointF axisStart;
    
    /** the end of the axis */
    private PointF axisEnd;
    ...
    public void parse(PDFObject shaderObj) throws IOException
    {
        ...
        PointF start = new PointF(coords[0].getFloatValue(), coords[1].getFloatValue());
        PointF end   = new PointF(coords[2].getFloatValue(), coords[3].getFloatValue());
        setAxisStart(start);
        setAxisEnd(end);
     ...
     */
    protected void setAxisStart(PointF axisStart) {
     ...
     * Set the start of the axis
     */
    protected void setAxisEnd(PointF axisEnd) {
    ...
    class Type2Paint extends Paint {
                                          ...
                                          RenderingHints hints) 
        {
            ...
            PointF devStart = xform.transform(getAxisStart(), null);
            PointF devEnd = xform.transform(getAxisEnd(), null);
