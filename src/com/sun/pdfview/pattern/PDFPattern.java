/*
 * $Id: PDFPattern.java,v 1.3 2007-12-20 18:33:30 rbair Exp $
 *
...
public abstract class PDFPattern {
	...
	public static PDFPattern getPattern(PDFObject patternObj, Map<?, ?> resources) throws IOException {
		...
		if (matrix == null) {
			...
			xform = new Matrix();
			//TODO FIXME setValues elts);
			Utils.setMatValues(xform,elts[0],elts[1],elts[2],elts[3],elts[4],elts[5]);
		}

		switch (type) {
			case 1:
				//TODO FIXME pattern = new PatternType1();break;
	 ...
	 */
	protected void setTransform(Matrix xform) {
		this.xform = xform;
	}
